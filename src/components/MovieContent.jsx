...
const MovieContent = React.memo(function MovieContent({ data }) {
  ...
  return (
    <>
      <Header>
        <SearchTab onInputChange={handleInputChange} />
      </Header>
        {filteredData.length === 0 && <Info className="text-white mt-20 w-full flex justify-center titillium-web-bold"><p>OOPS !!! no result ....</p></Info>}
        {filteredData &&
